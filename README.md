...
В процессе разработки проекта, в условиях ограниченного времени, использовались ИИ-агенты для ускорения отдельных этапов. При этом архитектура и основная логика проекта были полностью разработаны мной.
